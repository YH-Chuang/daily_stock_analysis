...
const settingsHelpZhCN: SettingsHelpMap = {
  ...
  'settings.notification.report_output': {
    ...
    usage: 'REPORT_TYPE 可选 simple/full/brief，REPORT_LANGUAGE 可选 zh/zh-tw/en/ko；Agent Chat 只有在未显式传入 context.report_language 时才继承这里的默认语言。',
...
const settingsHelpEnUS: SettingsHelpMap = {
  ...
  'settings.notification.report_output': {
    ...
    usage: 'REPORT_TYPE supports simple/full/brief. REPORT_LANGUAGE supports zh/zh-tw/en/ko. Agent Chat inherits this default only when context.report_language is omitted.',
